...
<div class="menu">
		...
		<ul>
			...
			<div id="login-content">
				<form name="addnode" method ="post" action="scripts/add_node.php">
					<fieldset id="inputs">
		...
		<ul>
			...
			<div id="login-content5">
				<form action="scripts/modify_node.php" method ="post">
					<fieldset id="inputs">
		...
		<ul>
			...
			<div id="login-content2">
				<form action="scripts/delete_node.php" method="post">
					<fieldset id="inputs">
		...
		<ul>
			...
			<div id="login-content4">
				<form action="scripts/delete_link.php" method="post">
					<fieldset id="inputs">
